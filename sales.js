...
function displayProducts(productArr) {
  ...
  // console.log("carArr ready to go into DOM", cardArr);
...
// TODO function to respond to dropdown
document.getElementById("dropdown").addEventListener("change", function() {
  ...
  //grab all product cards from DOM
...
// console.log( "card", buildCard(TempObj) );
  ...
  } //to fixed is numbers after decimal, + before string becomes a number
...
function getCategories() {
  ...
  reqCategories.open("GET", "categories.json");
  reqCategories.send();
}
...
function getProducts() {
  ...
  reqProducts.open("GET", "products.json");
  reqProducts.send();
}
getProducts();
